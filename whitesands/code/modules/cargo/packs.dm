...
/datum/supply_pack/misc/traitor_ammo
	...
	desc = "Contains three 10mm stechkin magazines, two .357 magnum speedloaders, two 8mm AP magazines, and a box of buckshot for good measure. Comes in a re-usable coffin."
