...
const _CharacterSetup = () => {
  ...
  const CharacterSlot = {
    ...
    custom_name_prefs: PropTypes.objectOf(
      PropTypes.shape(CustomNamePreferenceValue)
    ),
  ...
  const CharacterSetupData = {
    ...
    pref_defines: {
      ...
      custom_names: PropTypes.arrayOf(
        PropTypes.shape(CustomNamePreferenceDefine)
      ),
    },
  };
...
const _CharacterAppearance = () => {
  ...
  const CharacterAppearanceData = {
    species_define: PropTypes.arrayOf(PropTypes.shape(SpeciesDefine)),
  };
