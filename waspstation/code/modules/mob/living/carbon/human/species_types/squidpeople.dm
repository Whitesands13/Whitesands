/datum/species/squid
	...
	special_step_sounds = list('waspstation/sound/effects/footstep/squid1.ogg', 'waspstation/sound/effects/footstep/squid2.ogg', 'waspstation/sound/effects/footstep/squid3.ogg')
