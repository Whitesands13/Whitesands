...
/datum/job/lieutenant
  ...
  access = list(ACCESS_SECURITY, ACCESS_LAWYER, ACCESS_SEC_DOORS, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_HOP,
			            ACCESS_MEDICAL, ACCESS_ENGINE, ACCESS_EVA, ACCESS_HEADS,
			            ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION,
			            ACCESS_CARGO, ACCESS_RESEARCH, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_LIEUTENANT) //WS edit - irrelevant lawyer
