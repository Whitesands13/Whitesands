/obj/item/melee/weebstick
	...
	hitsound = 'waspstation/sound/weapons/anime_slash.ogg'
...
/obj/item/storage/belt/weebstick/AltClick(mob/user)
	...
	if(length(contents))
		...
		playsound(user, 'waspstation/sound/weapons/unsheathed_blade.ogg', 30, TRUE)
...
/obj/item/storage/belt/weebstick/proc/primed_attack(mob/living/user, obj/item/I)
	...
	primed = FALSE
	user.spin(4, 1)
	playsound(user, 'waspstation/sound/weapons/unsheathed_blade.ogg', 80)
