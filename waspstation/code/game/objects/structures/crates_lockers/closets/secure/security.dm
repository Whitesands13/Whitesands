...
/obj/structure/closet/secure_closet/lieutenant/PopulateContents()
	...
	new /obj/item/clothing/head/helmet/space/plasmaman/security/lieutenant(src)
	new /obj/item/clothing/under/plasmaman/lieutenant(src)
	new /obj/item/clothing/under/plasmaman/lieutenant/skirt(src)
