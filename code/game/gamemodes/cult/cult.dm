...
/datum/game_mode/cult
	...
	restricted_jobs = list("Chaplain","AI", "Cyborg", "Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Brig Physician", "Solgov Representative", "Prisoner") // Waspstation edit - Brig Physicians, Second Officer
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
