...
/datum/game_mode/changeling
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Brig Physician", "SolGov Representative", "Prisoner") // Waspstation edit - Brig Physicians, Second Officer
	required_players = 15
	required_enemies = 1
