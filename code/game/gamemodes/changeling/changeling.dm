...
/datum/game_mode/changeling
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Brig Physician", "Lieutenant", "Prisoner") // Waspstation edit - Brig Physicians, Second Officer
	required_players = 15
	required_enemies = 1
