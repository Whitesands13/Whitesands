...
GLOBAL_LIST_INIT(atmos_pipe_recipes, list(
	"Pipes" = list(
		...
		new /datum/pipe_info/pipe("Relief Valve",		/obj/machinery/atmospherics/components/binary/relief_valve), //Wasp Edit - Port of Relief Valves from Cit
	),
	"Devices" = list(
		...
		new /datum/pipe_info/pipe("Relief Valve",		/obj/machinery/atmospherics/components/unary/relief_valve), //Wasp Edit - Port of Relief Valves from Cit
