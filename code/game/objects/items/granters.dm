...
/obj/item/book/granter/martial/carp
	...
	directed directed toward you while in Throw mode. Your body is also honed to protect you from damage and punctures, and even survive space. \
	However, you are also unable to use any ranged weaponry, and some medical supplies will prove useless to you. You can learn more about your newfound art by using the Recall Teachings verb in the Sleeping Carp tab.</span>". However, you are also unable to use any ranged weaponry. You can learn more about your newfound art by using the Recall Teachings verb in the Sleeping Carp tab.</span>"
