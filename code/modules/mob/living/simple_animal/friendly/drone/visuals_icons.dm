...
/mob/living/simple_animal/drone/update_inv_hands()
	...
	if(r_hand)
		...
		if(client && hud_used && hud_used.hud_version != HUD_STYLE_NOHUD)
			...
			r_hand.screen_loc = hud_used.ui_hand_position(get_held_index_of_item(r_hand))
	...
	if(l_hand)
		...
		if(client && hud_used && hud_used.hud_version != HUD_STYLE_NOHUD)
			...
			l_hand.screen_loc = hud_used.ui_hand_position(get_held_index_of_item(l_hand))
...
/mob/living/simple_animal/drone/proc/update_inv_internal_storage()
	if(internal_storage && client && hud_used && hud_used.hud_shown)
		internal_storage.screen_loc = hud_used.ui_layout["ui_drone_storage"]
...
/mob/living/simple_animal/drone/update_inv_head()
	...
	if(head)
		if(client && hud_used && hud_used.hud_shown)
			head.screen_loc = hud_used.ui_layout["ui_drone_head"]
			client.screen += head
