...
/datum/species/proc/spec_attacked_by(obj/item/I, mob/living/user, obj/item/bodypart/affecting, intent, mob/living/carbon/human/H, modifier)
	...
	apply_damage(I.force * modifier * weakness, I.damtype, def_zone, armor_block, H)
