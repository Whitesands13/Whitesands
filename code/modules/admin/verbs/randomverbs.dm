...
/client/proc/smite(mob/living/target as mob)
	...
	switch(punishment)
		...
		if(ADMIN_PUNISHMENT_NYA)//Boomer code by MaltVineger
			if(!iscarbon(target))
			...
			tonje.Insert(dude, TRUE, FALSE)//end of Boomer code, thanks to BAMPOT for helping with this one
