/client/proc/panicbunker()
	...
	SSredbot.send_discord_message("admin","[key_name(usr)] has toggled the Panic Bunker, it is now [new_pb ? "enabled with a living minutes requirement of [time_rec]" : "disabled"].","admin")
