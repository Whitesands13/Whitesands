/**
  * WS edots Proc called to check if the ninja can afford an ability's cost.
  *
...
/obj/item/clothing/suit/space/space_ninja/proc/ninjacost(cost = 0, specificCheck = 0)
	...
	if(cost && cell.charge < actualCost)
		...
		//This shit used to be handled individually on every proc.. why even bother with a universal check proc back in 2015?
