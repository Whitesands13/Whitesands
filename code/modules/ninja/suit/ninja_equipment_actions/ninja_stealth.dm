...
/**
  * WS edits Proc called to toggle ninja stealth.
  *
...
/obj/item/clothing/suit/space/space_ninja/proc/toggle_stealth()
	...
	if(stealth)
		...
		ninja.visible_message("<span class='warning'>[ninja.name] seemingly vanishes into thin air!</span>", \
						"<span class='notice'>You are now mostly invisible to normal detection.</span>")

/**
  * WS edits Proc called to cancel stealth.
  *
...
/obj/item/clothing/suit/space/space_ninja/proc/cancel_stealth()
	...
	if(stealth)
		...
		ninja.visible_message("<span class='warning'>[ninja.name] seemingly appears from thin air!</span>", \
