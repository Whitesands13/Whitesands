...
/obj/item/clothing/head/helmet/space/plasmaman/command
	...
	armor = list("melee" = 40, "bullet" = 50, "laser" = 50, "energy" = 60, "bomb" = 50, "bio" = 100, "rad" = 50, "fire" = 100, "acid" = 100) // WS BEGIN - plasmeme command helmets buff start
...
/obj/item/clothing/head/helmet/space/plasmaman/engineering/ce
	...
	armor = list("melee" = 40, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 50, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 90) // WS Edit - plasmeme command helmets buff
...
/obj/item/clothing/head/helmet/space/plasmaman/cmo
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 10, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 75) // WS Edit - plasmeme command helmets buff
...
/obj/item/clothing/head/helmet/space/plasmaman/security/hos
	...
	armor = list("melee" = 45, "bullet" = 25, "laser" = 30, "energy" = 40, "bomb" = 25, "bio" = 100, "rad" = 50, "fire" = 95, "acid" = 95) // WS Edit - plasmeme command helmets buff
...
/obj/item/clothing/head/helmet/space/plasmaman/rd
	...
	armor = list("melee" = 30, "bullet" = 5, "laser" = 10, "energy" = 20, "bomb" = 100, "bio" = 100, "rad" = 60, "fire" = 60, "acid" = 80) // WS BEGIN - plasmeme command helmets buff
