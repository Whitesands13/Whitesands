...
/datum/controller/subsystem/mapping/proc/loadWorld()
	...
	if (config.minetype == "icemoon")    // WS Edit - Merged Whitesands and Lavaland
		...
		LoadGroup(FailedZs, "Lavaland", "map_files/Mining", "LavalandOmega.dmm", default_traits = ZTRAITS_LAVALAND)         // WS Edit - Merged Whitesands and Lavaland "Omega"
